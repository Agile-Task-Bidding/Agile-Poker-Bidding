...
class HomePage extends Component {
    ...
    async componentDidMount() {
        ...
        this.props.roomServiceSocket.on('user_joined', event => this.onUserJoined(event));
        this.props.roomServiceSocket.on('user_disconnected', event => this.onUserDisconnected(event));
    }
